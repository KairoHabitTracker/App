            ...
            <YStack style={{padding: 16, flex: 1, backgroundColor: '#ffffff'}}>
                ...
                <YStack style={{marginTop: 24}}>
                    ...
                    <YStack style={{marginTop: 8, gap: 8}}>
                        ...
                        <Button aria-label="Delete account" onPress={() => { /* placeholder delete flow */
                ...
                <YStack style={{marginTop: 24}}>
                    ...
                    <YStack style={{marginTop: 8}}>
                        ...
                        <Button aria-label="Open help" onPress={() => router.push('../settings/about')}
                                style={{marginTop: 8}}>
                            Help & support
                        </Button>
                    </YStack>
                ...
                <YStack style={{marginTop: 32}}>
                    <Button aria-label="Log out" onPress={() => {
                        logout();
                    ...
                    <Button aria-label="Log out from all devices" onPress={() => setConfirmOpen(true)}
                            style={{backgroundColor: '#e53935', color: '#fff', marginTop: 8}}>
                ...
                {confirmOpen ? (
                    <YStack style={{
                        ...
                        <YStack
                            ...
                            <Text style={{marginTop: 8}}>This will sign you out of every device where you're logged in.
                                Are
                                you sure?</Text>
