  ...
  return (
    <View style={s.screen}>
      ...
      <FlatList
        ...
        renderItem={({item}) => <FriendListItem friend={item} getAvatarUrl={getAvatarUrl} />}
        ...
        ListHeaderComponent={
          <>
            ...
            {friends.length > 0 && (
              <Text style={[s.sectionTitle, {marginTop: 24}]}>ALL FRIENDS ({friends.length})</Text>
            )}
          </>
        }
        ...
        ListEmptyComponent={
          !isLoading && invitations.length === 0 ? (
            <View style={s.emptyState}>
              ...
              <Text style={s.emptyStateText}>No friends yet. Add someone!</Text>
              <SharedButton
