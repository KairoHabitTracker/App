...
export const InviteModal = ({inviteCode, setInviteCode, onSend, isSending}: InviteModalProps) => {
  ...
  return (
    <View style={styles.inviteContainer}>
      <View style={styles.inputWrapper}>
        ...
        />
        <TouchableOpacity onPress={onSend} disabled={isSending} style={styles.sendIconBtn}>
          {isSending ? (
